...
var playerHP = 100; //health of player
var enemyHP = 100; //health of enemy 
var healthRegain = 3; //time health can be regained
let enemiesList = ['Archer', 'Samurai', 'Ghoul', 'Bomberman']; //enemies list
var enemyToFight; //randomly selecting enemy
...
async function strike() {
    ...
    if (enemyToFight == 'Archer') {
        ...
        let playerDamage = Math.ceil(Math.random() * 20); //damage player will cause
        let enemyDamage = Math.ceil(Math.random() * 10); //damage the enemy will cause
        ...
        let playerDamage = Math.ceil(Math.random() * 19); //damage caused by player and enemy
        ...
        let playerDamage = Math.ceil(Math.random() * 18); //damage caused by player and enemy
        ...
        let playerDamage = Math.ceil(Math.random() * 17); //damages caused
